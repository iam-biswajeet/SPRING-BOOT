...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(userRepo.count());
		  ...
		  entity.setId(105); entity.setName("Jyoti"); entity.setPhno(7735l);
		  ...
		  entity1.setPhno(7978l); entity1.setAge(22);
		  entity1.setCountry("India"); User entity2=new User(); entity2.setId(107);
		  entity2.setName("Ramaksnta"); entity2.setPhno(79781l);
		...
		System.out.println("========================================");
		Iterable<User> lists=userRepo.findAllById(Arrays.asList(101,102));
